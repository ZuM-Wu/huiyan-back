    ...
    try {
        for (const path of dependencies) {
            ...
            await new Promise((resolve, reject) => {
                ...
                script.src = '/static/' + path + '?v=3.4.0-hardware-schedule-1&library=1';
        ...
        HuiYan.createPluginPage({ plugin: 'hardware_jjr', page: 'index', setup: window.HuiYanHardwareManagement.setup });
    } catch (_) {
        if (active()) {
