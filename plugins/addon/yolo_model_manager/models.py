...
class RecognitionRecord(Base):
    ...
    area_id = Column(Integer, nullable=False, comment="识别时所属产区ID快照")
    area_name = Column(String(128), nullable=False, comment="识别时所属产区名称快照")
    plot_id = Column(Integer, nullable=False, comment="识别地块ID快照")
    plot_name = Column(String(128), nullable=False, comment="识别地块名称快照")
